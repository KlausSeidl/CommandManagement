...
namespace Skc.BestPractices.CommandManager
{
    ...
    public sealed class CommandManager
    {
        ...
        // and the list of undone commands for a redo. 
        ...
        /// <summary>Event raised when history of commands changed.</summary>
        public event EventHandler<EventArgs> CommandHistoryChanged;

        /// <summary>Event raised when future (redo list) of commands changed.</summary>
        ...
        /// <summary>Event raised before a command will be executed.</summary>
        ...
        /// <summary>Event raised when a command was executed.</summary>
        ...
        /// <summary>Event raise when a command was discarded.</summary>
        ...
        public void EndGroup()
        {
            ...
            OnCommandHistoryChanged(new EventArgs());
            // Destroy the group 
            _currentGroup = null;
        }
        ...
        public object Undo()
        {
            ...
            var retval = commandToBeUndone.Undo();
        ...
        public object Redo()
        {
            ...
            // Undo the command 
            var retval = commandToBeRedone.Execute();
        ...
        {
            return new List<Command>(_commandHistory);
        }
        ...
        {
            return new List<Command>(_undoneCommands);
        }
