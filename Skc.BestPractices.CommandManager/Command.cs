...
namespace Skc.BestPractices.CommandManager
{
    ...
    {
        /// <summary>Use the Description Property to describe what this command does</summary>
        public string Description = "";

        /// <summary>Use the Discard Property to cancel execution and to tell the command manager not to put the command on the stack</summary>
        ...
        /// <summary>Gets an explanatory message why this command cannot be undone. By default all commands can be undone and therefor this message is empty</summary>
